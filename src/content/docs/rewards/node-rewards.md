...
### Standard Node (Silver 티어)

```
최소 스테이킹: 1,000 SELA
예상 처리량: 하루 500-1,000 요청
우선순위: 중간
월 예상 수익: 100-200 SELA (네트워크 활동에 따라 변동)
추가 혜택: 통계 대시보드 접근
```
...
### Professional Node (Gold 티어)

```
최소 스테이킹: 5,000 SELA
예상 처리량: 하루 2,000-5,000 요청
우선순위: 높음
월 예상 수익: 500-1,000 SELA (네트워크 활동에 따라 변동)
...
| ---------------- | --------- | -------- | ----------------------------- |
| Micro (Bronze)   | 100       | 일반     | 기본 보상만                   |
| Standard (Silver)| 1,000     | 중간     | 통계 대시보드                 |
| Professional (Gold)| 5,000   | 높음     | 전용 지원, 우선 작업 배정     |
| Enterprise (Platinum)| 10,000+ | 최우선  | 거버넌스 참여, 의사결정 권한  |
...
**크롬 확장 프로그램 모드 (Micro/Standard Node):**
...
**독립 노드 (Professional/Enterprise Node):**
